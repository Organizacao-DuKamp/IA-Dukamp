# Status da implementação da RAG pecuária
...
3. Confirmar que os novos documentos ficaram `concluido`.
4. Executar a matriz de perguntas de validação.

Não substituir toda a base para ativar este pacote.
