...
const heroBullPhoto = "/tpec-hero-bull.webp?v=sr-2400-20260921";
...
const benefits = [
  {
    ...
    text: "Envie fotos e use a imagem como parte da análise da TPEC-IA.",
  },
  {
    icon: "clock",
    title: "Respostas rápidas",
    text: "Informações organizadas para você entender o cenário com agilidade.",
  },
  {
    icon: "shield",
    title: "Decisões mais seguras",
    text: "Mais contexto e pontos de atenção para apoiar a tomada de decisão.",
  },
  {
    icon: "chart",
    title: "Tecnologia no campo",
    text: "Inteligência artificial aplicada à rotina da fazenda, sem complicação.",
  },
];
...
const areas: Area[] = [
  {
    ...
    text: "Manejo, pasto, ganho de peso e suplementação.",
    crop: "area-crop-beef",
  },
  {
    title: "Bovinos de leite",
    text: "Alimentação, rotina do rebanho e produtividade.",
    crop: "area-crop-dairy",
  },
  {
    title: "Equinos",
    text: "Condição corporal, manejo e cuidados gerais.",
    crop: "area-crop-horse",
  },
  {
    title: "Ovinos e caprinos",
    text: "Nutrição, reprodução e rotina de manejo.",
    crop: "area-crop-sheep",
  },
  ...
  if (name === "clock")
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24">
        ...
        <path d="M12 7v5l3 2M3 8H1M4 5 2.5 3.5M3 12H1" />
      </svg>
    );
  if (name === "shield")
    return (
...
function UseIcon({ name }: { name: string }) {
  ...
  if (name === "feed")
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24">
        <path d="M4 9h16l-2 10H6zM7 9l2-4h6l2 4" />
        <path d="M9 13h6" />
      </svg>
    );
  if (name === "eye")
  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24">
      <path d="M5 10c0-4 3-6 7-6s7 2 7 6v6c0 2-1.5 4-4 4h-6c-2.5 0-4-2-4-4z" />
      <path d="M8 9h.01M16 9h.01M9 15c2 1 4 1 6 0" />
    </svg>
  );
}
...
function HeroScanIcon({ name }: { name: "management" | "nutrition" | "condition" }) {
  ...
  if (name === "condition") {
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24">
        ...
        <path d="M5.5 13h3l1.5-3 3 6 1.5-3h4" />
      </svg>
    );
  }
  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24">
      <path d="M4 20h16M6 17v-5M11 17V7M16 17V4" />
      <path d="m5 9 5-4 5 2 4-4" />
    </svg>
  );
}
    ...
    <main className="tpec-landing">
      ...
      <section className="poster poster-whatsapp poster-whatsapp-adapted" id="whatsapp">
        ...
        <div className="whatsapp-copy reference-copy">
          ...
          <p>
            Tire dúvidas, envie fotos e receba orientações técnicas direto pelo WhatsApp. Prático,
            rápido e feito para o pecuarista.
          </p>
          <a
            className="reference-button whatsapp-big"
            href={whatsappUrl}
            target="_blank"
            rel="noreferrer"
        ...
        <div className="whatsapp-phone" aria-label="Exemplo de conversa com a TPEC-IA no WhatsApp">
          ...
          <div className="phone-header">
            ...
            <span className="phone-actions" aria-hidden="true">
              ⌕ ⋮
            </span>
          </div>
          <div className="phone-body">
            <div className="bubble incoming">
              <b>Produtor</b>
              <p>Estou com uma dúvida sobre meu gado. Posso mandar uma foto?</p>
              <time>11:28</time>
            </div>
            <div className="bubble outgoing">
              <b>TPEC IA</b>
              <p>Claro. Envie a foto e me conte o que você observou.</p>
              <time>11:29 ✓✓</time>
            </div>
            <div className="phone-photo phone-reference-crop">
              <img src={whatsappReferenceImage} alt="Bovino enviado para análise" loading="lazy" />
            </div>
            <div className="bubble outgoing compact-bubble phone-guidance">
              <b>TPEC IA</b>
              <p>Obrigado pela foto. Pelo que foi observado, recomendamos:</p>
              <ul>
                <li>Verificar o manejo nutricional;</li>
                <li>Observar presença de carrapatos;</li>
                <li>Acompanhar a condição corporal.</li>
              </ul>
              <p>Qualquer mudança, me avise!</p>
              <time>11:31 ✓✓</time>
            </div>
          </div>
        ...
        <div className="whatsapp-field reference-photo">
          <img
            className="whatsapp-field-reference"
            src={whatsappReferenceImage}
            alt="Pecuarista usando o celular ao lado de um bovino no campo"
            fetchPriority="high"
          />
      ...
      <section className="poster poster-hero" id="inicio">
        ...
        <div className="hero-copy reference-copy">
          ...
          <div className="hero-actions">
            <a className="reference-button" href={whatsappUrl} target="_blank" rel="noreferrer">
              <WhatsappIcon /> CONVERSAR COM A TPEC-IA
            </a>
            <a className="outline-button" href="#como-funciona">
              VER COMO FUNCIONA <ArrowIcon />
            </a>
          </div>
        </div>
      ...
      <section className="poster poster-analysis" id="analise">
        <div className="analysis-field reference-photo">
          <img src={herdWide} alt="Bovinos em pastagem" loading="lazy" />
        ...
        <div className="analysis-phone" aria-label="Painel de análise por foto">
          ...
          <div className="analysis-cow-photo">
            <img src={cattlePhoto} alt="Bovino analisado pela TPEC-IA" loading="lazy" />
            <i className="focus top-left" />
            <i className="focus top-right" />
            <i className="focus bottom-left" />
            <i className="focus bottom-right" />
          </div>
          <div className="analysis-row">
            ...
            <span>
              <b>Condição corporal</b>
              <small>Boa cobertura aparente. Avaliar no contexto do lote.</small>
            </span>
          </div>
          <div className="analysis-row">
            <i>
            ...
            <span>
              <b>Sinais observados</b>
              <small>Sem alterações visíveis relevantes na imagem.</small>
            </span>
          </div>
          <div className="analysis-row">
            <i>
            ...
            <span>
              ...
              <small>Acompanhar evolução e manejo nutricional.</small>
            </span>
          </div>
          <div className="analysis-row">
            <i>
            ...
            <span>
              <b>Orientação</b>
              <small>Acrescente idade, objetivo e histórico para aprofundar.</small>
            </span>
          </div>
          <p className="analysis-disclaimer">
            Análise por IA como apoio à decisão. Não substitui avaliação técnica presencial.
          </p>
        </div>
        <div className="analysis-copy reference-copy">
          ...
          <h2>
            ...
            <br />A TPEC-IA ajuda você a entender.
          </h2>
          <p>
            Envie uma foto do animal, do pasto, do cocho ou de qualquer situação no campo. A TPEC-IA
            organiza observações práticas para apoiar suas decisões.
          </p>
          <div className="analysis-features">
            <span>
              ...
              <b>Envie sua foto</b>
              <small>Animal, pasto, cocho ou situação de campo.</small>
            </span>
            <span>
              <i>
                <SparkIcon />
              ...
              <b>IA que analisa</b>
              <small>Identifica informações visuais e organiza o contexto.</small>
            </span>
            <span>
              <i>
                <FeatureIcon name="chart" />
              ...
              <small>Observações e pontos de atenção apresentados com clareza.</small>
            </span>
            <span>
              <i>
                <UseIcon name="eye" />
              </i>
              <b>Apoio para decidir</b>
              <small>Continue a conversa e aprofunde o cenário.</small>
            </span>
          </div>
        </div>
      ...
      <section className="poster poster-how" id="como-funciona">
        <div className="how-copy reference-copy">
          ...
          <span className="gold-divider wide" aria-hidden="true">
            <i />
          </span>
          <div className="reference-steps">
            <article>
              ...
              <b>1. FOTOGRAFE</b>
              <p>Tire uma foto do animal, pasto, cocho ou situação que chamou sua atenção.</p>
            </article>
            <i className="step-arrow">→</i>
            <article>
              <span>
                <WhatsappIcon />
              </span>
              <b>2. PERGUNTE</b>
              <p>Conte o que deseja saber ou descreva sua dúvida como em uma conversa.</p>
            </article>
            <i className="step-arrow">→</i>
            <article>
              <span>
              ...
              <b>3. A IA ANALISA</b>
              <p>A TPEC-IA cruza a imagem e o contexto para organizar uma resposta clara.</p>
            </article>
            <i className="step-arrow">→</i>
            <article>
              <span>
        ...
        <div className="how-field reference-photo">
          ...
          <div className="photo-fade left-fade" aria-hidden="true" />
          <div className="scan-board board-one">
            <b>ANÁLISE CORPORAL</b>
            <span>
              Musculatura <i style={{ width: "78%" }} />
            </span>
            <span>
              Condição <i style={{ width: "68%" }} />
            </span>
            <span>
              Estrutura <i style={{ width: "82%" }} />
            </span>
          </div>
          <div className="scan-board board-two">
            <b>DESTAQUES</b>
            <span>✓ Potencial do lote</span>
            <span>✓ Conformação</span>
      ...
      <section className="poster poster-benefits" id="beneficios">
        <div className="benefits-landscape" aria-hidden="true">
          <img src={cattleWide} alt="" />
        </div>
        <BrandSeal />
        <div className="benefits-head">
          <span className="gold-title">BENEFÍCIOS</span>
          <span className="gold-divider wide" aria-hidden="true">
            <i />
          </span>
        ...
        <div className="reference-benefits-grid">
          {benefits.map((item) => (
            <article key={item.title}>
              <span className="benefit-round-icon">
                <FeatureIcon name={item.icon} />
              </span>
              <i className="card-divider" />
              <h3>{item.title}</h3>
              <p>{item.text}</p>
            </article>
          ))}
      ...
      <section className="poster poster-areas" id="areas">
        ...
        <div className="areas-head">
          <span className="gold-title">ÁREAS DA PECUÁRIA</span>
          <span className="gold-divider wide" aria-hidden="true">
            <i />
          </span>
          <h2>Soluções inteligentes para cada atividade de campo.</h2>
          <p>Mais contexto para diferentes espécies, rotinas e sistemas de produção.</p>
        </div>
        <div className="reference-areas-grid">
          {areas.map((area) => (
            <article key={area.title}>
              <div
                className={`area-photo area-photo-reference ${area.crop}`}
                role="img"
                aria-label={area.title}
              />
              <span className="area-icon">
                <UseIcon name={area.title.includes("Pisc") ? "eye" : "cow"} />
              </span>
              <h3>{area.title}</h3>
              <p>{area.text}</p>
            </article>
      ...
      <section className="poster poster-examples">
        ...
        <div className="examples-head">
          <span className="gold-title">EXEMPLOS DE USO</span>
          <span className="gold-divider wide" aria-hidden="true">
            <i />
          </span>
      ...
      <section className="faq-section" id="duvidas">
        <div className="faq-heading">
          <span className="reference-kicker">DÚVIDAS FREQUENTES</span>
          <h2>O que você precisa saber antes de começar.</h2>
          <p>
            Se ainda tiver uma pergunta, fale com a TPEC-IA pelo WhatsApp e teste a experiência.
          </p>
        </div>
        <div className="faq-list">
          {faqs.map((faq) => (
            <details open key={faq.question}>
              <summary>
                {faq.question}
                <span>+</span>
              </summary>
      ...
      <section className="final-cta">
        <BrandSeal />
        <div>
          <span className="reference-kicker">CAMPO + INTELIGÊNCIA</span>
          <h2>Leve a TPEC-IA para a sua rotina.</h2>
          <p>
            Comece uma conversa agora e descubra como a inteligência artificial pode apoiar o seu
            dia no campo.
          </p>
        </div>
        <a className="reference-button" href={whatsappUrl} target="_blank" rel="noreferrer">
