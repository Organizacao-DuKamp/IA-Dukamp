...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.svg?v=20260903-2", type: "image/svg+xml" },
      { rel: "shortcut icon", href: "/favicon.svg?v=20260903-2", type: "image/svg+xml" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="pt-BR">
      ...
      <body>
        {children}
        <script src="/landing-animations.js" defer />
        <Scripts />
      </body>
    </html>
  );
